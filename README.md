...
### Project Files
- `Projet Température Terrestre NGUYEN Hoang Dung`
- `Berkeley_France.ipynb`
- `CO2.ipynb`
- `Combine.ipynb`
- `DataCO2_nguyen.ipynb`
- `Emissions_CO2_Calculs.ipynb`
- `ZoneAnn.ipynb`
- `france_monthly_mean_temperature.ipynb`
- `global_updated.ipynb`
- `project_ovid_co2.ipynb`
